    ...
    return (
        <div className="sidebar">
            <ul className="sidebar-menu">
                ...
                <li className={activeTab === 'Patient Support' ? 'active' : ''} onClick={() => setActiveTab('Patient Support')}>
                    Patient Support
                </li>
                <li className={activeTab === 'Pharmacy' ? 'active' : ''} onClick={() => setActiveTab('Pharmacy')}>
                    Pharmacy
                </li>
                <li className={activeTab === 'Nursing Services' ? 'active' : ''} onClick={() => setActiveTab('Nursing Services')}>
                    Nursing Services
                </li>
                <li className={activeTab === 'Lab Services' ? 'active' : ''} onClick={() => setActiveTab('Lab Services')}>
                    Lab Services
                </li>
                <li className={activeTab === 'Health Insurance Claims' ? 'active' : ''} onClick={() => setActiveTab('Health Insurance Claims')}>
