...
# Load the data
df = pd.read_csv('../training/datasets/requests.csv')
...
id2label = {
    0: "Technical Support", 1: "Billing", 2: "Sales", 3: "Insurance", 4: "General",
    5: "Appointments", 6: "Medical Records", 7: "Patient Support", 8: "Pharmacy", 9: "Nursing Services",
    10: "Lab Services", 11: "Health Insurance Claims", 12: "IT Support"
}
label2id = {v: k for k, v in id2label.items()}  # Reversing id2label for label2id

model = AutoModelForSequenceClassification.from_pretrained(model_path, num_labels=13, id2label=id2label, label2id=label2id)
